...
export async function saveItemBatch(items, siteAPI, wixCollection) {
  //const hmac = CryptoJS.createHmac('sha256', siteAPI.secret);
    const hmac = CryptoJS.HmacSHA256('sha256', siteAPI.secret);
...
export async function batchCheckUpdateState(items, siteAPI, wixCollection) {
  ...
  //const hmac = CryptoJS.Hmac('sha256', siteAPI.secret);
  const hmac = CryptoJS.HmacSHA256('sha256', siteAPI.secret);
